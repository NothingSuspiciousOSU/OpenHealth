...
function buildInstructions(documentContext?: BillDocumentContext) {
  ...
  return [
    ...
    "",
    "2. webResearchAgent",
    "Use this aggressively for public external context and to ground answers in current sources:",
    ...
    "Default to using webResearchAgent whenever an answer would benefit from external grounding, even if you think you already know the answer.",
    "Use webResearchAgent before answering questions that depend on external facts, public policies, CPT or billing definitions, medical billing concepts, current information, or anything likely to vary by payer, provider, state, or date.",
    "Only skip webResearchAgent when the answer is fully covered by the user's bill context, OpenHealth price data, simple arithmetic, or a brief clarifying question.",
    "When you use web results, cite the returned URLs in your answer and separate sourced facts from your interpretation.",
    "",
    ...
    "- If the user asks what a CPT code, charge type, denial, adjustment, billing term, payer rule, or public policy means, use webResearchAgent to ground the answer unless the provided bill text fully answers it.",
    "- When uncertain whether webResearchAgent is needed, use it.",
    ...
    "",
    "Answer style:",
    "- Be direct, practical, and concise: usually 3-6 sentences or a short bullet list.",
    "- Lead with the most useful conclusion.",
    "- Do not include long background explanations unless the user asks for detail.",
    "- Show only the most relevant evidence used: bill context, OpenHealth records, web sources, or calculation results.",
