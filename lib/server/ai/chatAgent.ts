...
function buildInstructions(documentContext?: BillDocumentContext) {
  ...
  return [
    ...
    "",
    "2. webResearchAgent",
    "Use this for public external context and to ground answers in current sources:",
    ...
    "Use webResearchAgent before answering questions that depend on external facts, public policies, CPT or billing definitions, current information, or anything likely to vary by payer, provider, state, or date.",
    "Skip webResearchAgent only when the answer is fully covered by the user's bill context, OpenHealth price data, or general non-current reasoning.",
